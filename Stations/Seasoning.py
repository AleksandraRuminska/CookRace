...
class Seasoning(Station):
    ...
    def can_empty_utensil_here(self, utensil):
        if self._current_item is None and issubclass(type(utensil), Utensil) and len(utensil.ingredients) == 1 and utensil.ingredients[0].seasonable():
            return True
        else:
            return False
